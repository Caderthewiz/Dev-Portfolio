...
<header class="info">
    <div class="titles">
        <h1 class="title">Cade Cameron</h1>
        <p class="subtitle">Software Developer</p>
        <p class="description">Computer Science and Pure Mathematics</p>
        <p class="description">
            <a href="https://traianamariucai.wixsite.com/amariucai/pits-lab" target="_blank" rel="noopener noreferrer">PITS Research Lab</a>
        </p>
